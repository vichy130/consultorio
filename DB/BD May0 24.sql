...
-- Paciente 10
insert into paciente (nombre, apellidoPaterno, apellidoMaterno, sexo, lugarNacimiento, calle, colonia, ciudad, codigoPostal, telcasa, telOficina,celular, edoCivil, ocupacion, escolaridad, correo, fechaNacimiento) 
values ("PEDRO", "GONZALEZ", "MARTINEZ", "masculino", "Tlaquepaque", "Av. Vallarta 3000", "La estancia", "Tlaquepaque", "45500", 333333, 3333333, 3333333, "casado", "Contador", "Maestría", "pedrogonzalez@example.com", "1988-11-18");
