...
class TerapiaReportePDF extends FPDF
{
    private $reporte = [];
    private $tipo;
    ...
    function header()
    {
        ...
        $titulo = $this->convertir("Informe de terapias");
    ...
    function cuerpo()
    {
        switch ($this->tipo) {
            case "tres":
                $texto = $this->convertir("en últimos tres meses");
                break;
            case "seis":
                $texto = $this->convertir("en últimos seis meses");
                break;
            case "ano":
                $texto = $this->convertir("en último año");
                break;
            case "tipo":
                $texto = $this->convertir("por tipo");
                break;
            case "todo":
                $texto = "";
                break;
        ...
        $this->SetFont('Times', '', 12);
        $this->Cell(189, 5, "Historial de terapias registradas " . $texto, 0, 1, '');
        $this->Ln(2);
        $this->SetFont('Times', 'B', 12);
        $this->Cell(94.5, 5, "Terapia: ", 0, 0, '');
